module Gui::Views::Players
	...
	# http://0.0.0.0:3000/widgets/HooHtml5PlaylistPlayer
	# http://shooley.audioboo.fm:3000/widgets/HooHtml5PlaylistPlayer

	# So, a player, and scrolling list of boos
	# click on a boo to load it into the player
	# Disclosure arrow to go to detail page
	# player on detail page?

	class HooHtml5PlaylistPlayer < Gui::Core::HooView
